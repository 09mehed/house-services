        ...
        <div className='w-11/12 mx-auto'>
            ...
            <div className='flex lg:flex-row flex-col-reverse justify-between items-center gap-3'>
                <div className='w-full lg:w-1/2'>
                    <div className="collapse collapse-arrow bg-gray-300 my-3">
                        <input type="radio" name="my-accordion-2" defaultChecked />
                        <div className="collapse-title text-xl text-black font-medium">Water Service</div>
                    ...
                    <div className="collapse collapse-arrow bg-gray-300 my-3">
                        ...
                        <div className="collapse-title text-xl text-black font-medium">Furniture Service</div>
                        <div className="collapse-content text-black">
                    ...
                    <div className="collapse collapse-arrow bg-gray-300 my-3">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title text-xl text-black font-medium">House change service</div>
                        <div className="collapse-content text-black">
